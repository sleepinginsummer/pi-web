...
test("transforms the reviewed 0.85.1 source into a valid bounded per-cwd cache", () => {
  const result = patchPiSdkExtensionCache(ORIGINAL_0851_FIXTURE);
