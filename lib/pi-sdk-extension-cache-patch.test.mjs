...
test("transforms the reviewed 0.87.0 source into a valid bounded per-cwd cache", () => {
  const result = patchPiSdkExtensionCache(ORIGINAL_0870_FIXTURE);
