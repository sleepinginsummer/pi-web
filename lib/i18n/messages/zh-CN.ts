...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "system.label": "系统",
    "shadow.label": "Shadow",
    "shadow.enableSession": "为当前会话开启 Shadow Mind",
    "shadow.disableSession": "为当前会话关闭 Shadow Mind",
    "shadow.sessionUnavailable": "当前会话未加载 Shadow Mind 扩展",
    "session.info": "会话信息",
    "session.name": "名称",
    "session.file": "文件",
    ...
    "sidebar.rename": "重命名",
    "sidebar.pin": "标记会话",
    "sidebar.unpin": "取消标记会话",
    "sidebar.pinProject": "标记目录 {name}",
    "sidebar.unpinProject": "取消标记目录 {name}",
    "sidebar.delete": "删除",
    "sidebar.deleteWithShiftClick": "删除（按住 Shift 点击可跳过确认）",
    "sidebar.removeProjectButton": "移除 {name}",
    "sidebar.removeProjectTitle": "移除 {name}？",
    "sidebar.removeProjectDescription": "将从侧边栏移除此目录，并永久删除所属的 {count} 个会话。目录中的文件不会被删除。",
    "sidebar.removeProject": "移除并删除会话",
    ...
    "files.download": "下载文件",
    "files.reveal": "在访达中打开",
    "files.revealWindows": "在资源管理器中打开",
    "files.revealLinux": "在系统文件管理器中打开",
    "files.revealError": "无法打开系统文件管理器",
    ...
    "chat.submit": "提交",
    "chat.askReview": "检查答案",
    "chat.askQuestionProgress": "问题 {current}/{total}",
    "chat.askUnanswered": "尚未回答",
    "chat.askNoSelection": "未选择任何项",
    "chat.askEdit": "修改",
    "chat.askCustomPlaceholder": "输入自定义答案",
    "chat.askPrevious": "上一步",
    "chat.askNext": "下一题",
    "chat.askSubmit": "提交答案",
    "chat.askSubmitting": "正在提交…",
    "chat.askCollapse": "收起问题",
    "chat.askExpand": "展开问题",
    ...
    "chat.send": "发送",
    "chat.askSelection": "询问选中的文本",
    "chat.askInCurrent": "在此询问",
    "chat.askInNewChat": "在新聊天中询问",
    "chat.newQuoteChat": "基于选中文本新建聊天",
    ...
    "chat.dismissImageAttachmentError": "关闭图片附件错误提示",
    ...
    "chat.extensionWidgetAbove": "编辑器上方",
    "chat.extensionWidgetBelow": "编辑器下方",
    "chat.extensionWidgetLine": "1 行",
    ...
    "chat.currentReasoning": "当前推理级别：{level}",
    "chat.fast": "Fast",
    "chat.fastEnable": "开启 Fast 模式（OpenAI Priority processing）",
    "chat.fastDisable": "关闭 Fast 模式",
    "chat.changeToolPreset": "更改工具预设",
    "chat.stopCompaction": "停止压缩",
    "chat.compactContext": "压缩上下文",
    "chat.compacting": "正在压缩…",
    "chat.shadowMindStarted": "Shadow Mind 已启动：{id}\n\n{model}",
    "chat.shadowMindModel": "模型：{model}",
    "chat.shadowMindFinished": "Shadow Mind 已完成：{id}\n\n{detail}\n耗时：{duration} ms",
    "chat.shadowMindSilent": "未发现需要报告的问题",
    "chat.shadowMindFinishedReason": "结束原因：{reason}",
    "chat.shadowMindAborted": "Shadow Mind 已中止 {count} 个任务\n\n原因：{reason}",
    "chat.compact": "压缩",
    "chat.stopAgent": "停止 Agent",
    "chat.stop": "停止",
    "chat.typeYourAnswer": "输入你的答案…",
    "chat.disableSound": "关闭完成提示音",
    "chat.enableSound": "开启完成提示音",
    "chat.disableNotification": "关闭完成通知",
    "chat.enableNotification": "开启完成通知",
    "chat.notificationBlocked": "系统通知已被阻止，请在站点设置中允许",
    "chat.notificationPromptTitle": "开启任务完成通知",
    "chat.notificationPromptBody": "AI 回复完成后发送系统通知",
    "chat.notificationPromptLater": "暂不开启",
    "chat.notificationPromptEnable": "开启",
    "chat.notificationDoneBody": "AI 回复已完成",
    "chat.notificationAttentionTitle": "AI 正在等待输入",
    "chat.notificationAttentionBody": "AI 正在等待你的回复",
    "chat.inAppNotifications": "会话通知",
    "chat.openNotificationSession": "打开会话：{title}。{body}",
    ...
    "chat.todosTitle": "任务列表",
    "chat.todosExpand": "展开任务列表",
    "chat.todosCollapse": "收起任务列表",
    "chat.todosAllDoneLast": "全部完成 · 最后: {text}",
    "chat.modelDataWarning": "模型数据警告",
    "chat.modelUnknownThinkingLevel": "模型 {model} 包含未知思考等级 {level}，已忽略",
    "chat.modelUnknownThinkingMapLevel": "模型 {model} 映射了未知思考等级 {level}，已忽略",
    "chat.modelUnknownThinkingPin": "模型 {model} 固定了未知思考等级 {level}，已忽略",
    ...
    "i18n.noSkills": "未找到技能",
    "trash.title": "回收站",
    "trash.searchPlaceholder": "搜索已删除的会话…",
    "trash.empty": "回收站是空的",
    "trash.noMatches": "没有匹配的会话",
    "trash.restore": "恢复",
    "trash.purge": "彻底删除",
    "trash.purgeConfirm": "彻底删除后不可恢复，确定要删除“{title}”吗？",
    "trash.updatedAt": "更新于 {time}",
    "trash.clearAll": "清空回收站",
    "trash.clearConfirm": "将永久删除全部会话，不可恢复",
    "trash.clearing": "清空中…",
    "trash.detail": "会话详情",
    "trash.detailEmpty": "该会话没有可显示的内容",
    "trash.collapse": "折叠",
    "trash.expand": "展开",
    ...
    "models.catalogRefreshFailed": "配置已保存，但远程模型目录刷新失败",
    ...
    "chat.longMessageStats": "{characters} 字符 · {lines} 行",
    "chat.viewLongMessage": "查看全文",
    "chat.collapseLongMessage": "收起",
    "i18n.newSession": "新会话",
    ...
    "settings.chat": "聊天",
    "settings.quoteSelection": "选中文本时显示操作",
    ...
    "agents.maxConcurrentDescription": "每个主会话允许同时运行的子代理数量。",
    ...
    "auth.password": "密码",
    "auth.prompt": "登录后继续",
    "auth.tooManyAttempts": "尝试次数过多，请 {seconds} 秒后重试。",
    "settings.themeMist": "雾白",
    "settings.themePine": "松绿",
