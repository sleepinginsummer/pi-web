...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "system.label": "System",
    "shadow.label": "Shadow",
    "shadow.enableSession": "Enable Shadow Mind for this session",
    "shadow.disableSession": "Disable Shadow Mind for this session",
    "shadow.sessionUnavailable": "Shadow Mind is not loaded for this session",
    ...
    "files.closeAllTabs": "Close all file tabs",
    ...
    "sidebar.pinProject": "Pin {name}",
    "sidebar.unpinProject": "Unpin {name}",
    "sidebar.delete": "Delete",
    "sidebar.deleteWithShiftClick": "Delete (Shift+click to delete without confirmation)",
    "sidebar.removeProjectButton": "Remove {name}",
    "sidebar.removeProjectTitle": "Remove {name}?",
    "sidebar.removeProjectDescription": "This removes the directory from the sidebar and permanently deletes its {count} sessions. Files in the directory are not deleted.",
    "sidebar.removeProject": "Remove and delete sessions",
    ...
    "files.reveal": "Open in Finder",
    "files.revealWindows": "Open in File Explorer",
    "files.revealLinux": "Open in file manager",
    "files.revealError": "Unable to open the system file manager",
    ...
    "chat.earlierProcessItems": "{count} earlier process items",
    ...
    "chat.submit": "Submit",
    "chat.askReview": "Review answers",
    "chat.askQuestionProgress": "Question {current}/{total}",
    "chat.askUnanswered": "Not answered",
    "chat.askNoSelection": "No options selected",
    "chat.askEdit": "Edit",
    "chat.askCustomPlaceholder": "Type a custom answer",
    "chat.askPrevious": "Previous",
    "chat.askNext": "Next question",
    "chat.askSubmit": "Submit answers",
    "chat.askSubmitting": "Submitting…",
    "chat.askCollapse": "Collapse question",
    "chat.askExpand": "Expand question",
    ...
    "chat.dismissImageAttachmentError": "Dismiss image attachment error",
    ...
    "chat.extensionWidgetAbove": "Above editor",
    "chat.extensionWidgetBelow": "Below editor",
    "chat.extensionWidgetLine": "1 line",
    ...
    "chat.currentReasoning": "Current reasoning level: {level}",
    "chat.fast": "Fast",
    "chat.fastEnable": "Enable Fast mode (OpenAI Priority processing)",
    "chat.fastDisable": "Disable Fast mode",
    ...
    "chat.shadowMindStarted": "Shadow Mind started: {id}\n\n{model}",
    "chat.shadowMindModel": "Model: {model}",
    "chat.shadowMindFinished": "Shadow Mind finished: {id}\n\n{detail}\nDuration: {duration} ms",
    "chat.shadowMindSilent": "No issues to report",
    "chat.shadowMindFinishedReason": "End reason: {reason}",
    "chat.shadowMindAborted": "Shadow Mind aborted {count} task(s)\n\nReason: {reason}",
    "chat.compact": "Compact",
    "chat.stopAgent": "Stop agent",
    "chat.stop": "Stop",
    "chat.typeYourAnswer": "Type your answer…",
    "chat.disableSound": "Disable completion sound",
    "chat.enableSound": "Enable completion sound",
    "chat.disableNotification": "Disable completion notifications",
    "chat.enableNotification": "Enable completion notifications",
    "chat.notificationBlocked": "Notifications are blocked; allow them in site settings",
    "chat.notificationPromptTitle": "Enable completion notifications",
    "chat.notificationPromptBody": "Get a system notification when the AI finishes",
    "chat.notificationPromptLater": "Not now",
    "chat.notificationPromptEnable": "Enable",
    "chat.notificationDoneBody": "The AI response is ready",
    "chat.notificationAttentionTitle": "AI is waiting for input",
    "chat.notificationAttentionBody": "The AI is waiting for your response",
    "chat.inAppNotifications": "Session notifications",
    "chat.openNotificationSession": "Open session: {title}. {body}",
    "chat.subagentsTitle": "Background subagent status",
    "chat.subagentsRunning": "Background subagents · {count} running",
    "chat.subagentsNoTask": "No task description",
    "chat.subagentsStateRunning": "Running",
    "chat.subagentsStateFailed": "Failed",
    "chat.subagentsStateAwaitingResume": "Completed, awaiting main agent",
    "chat.subagentsStateAwaitingNextTurn": "Completed, awaiting next turn",
    "chat.todosTitle": "Task list",
    "chat.todosExpand": "Expand task list",
    "chat.todosCollapse": "Collapse task list",
    "chat.todosAllDoneLast": "All done · Last: {text}",
    "chat.modelDataWarning": "Model data warning",
    "chat.modelUnknownThinkingLevel": "Model {model} contains unknown thinking level {level}; ignored",
    "chat.modelUnknownThinkingMapLevel": "Model {model} maps unknown thinking level {level}; ignored",
    "chat.modelUnknownThinkingPin": "Model {model} pins unknown thinking level {level}; ignored",
    ...
    "i18n.copy": "Copy",
    "i18n.copied": "Copied",
    "i18n.copyFileContent": "Copy file content",
    "i18n.cancel": "Cancel",
    "i18n.save": "Save",
    "i18n.saving": "Saving…",
    "i18n.saved": "Saved",
    ...
    "trash.title": "Trash",
    "trash.searchPlaceholder": "Search deleted sessions…",
    "trash.empty": "Trash is empty",
    "trash.noMatches": "No matching sessions",
    "trash.restore": "Restore",
    "trash.purge": "Delete permanently",
    "trash.purgeConfirm": "This cannot be undone. Permanently delete “{title}”?",
    ...
    "trash.detail": "Session details",
    "trash.detailEmpty": "This session has no viewable content",
    ...
    "models.fastPriority": "Fast (Priority)",
    ...
    "models.catalogRefreshFailed": "Configuration saved, but the remote model catalog could not be refreshed",
    ...
    "chat.longMessageStats": "{characters} characters · {lines} lines",
    "chat.viewLongMessage": "View",
    "chat.collapseLongMessage": "Collapse",
    ...
    "chat.commandAutoCompact": "Toggle automatic context compaction (global setting)",
    "chat.truncatedByOutputLimit": "The response was truncated at the model output limit. Send a follow-up message to continue.",
    "chatMinimap.toolCalls": "{count} tool calls in this turn",
    ...
    "layout.resizeSidebarSections": "Resize session list and file explorer",
    "models.catalogOffline": "PI_OFFLINE is set; Pi Web will not fetch the model catalog.",
    "models.catalogUnchanged": "Model catalog is up to date.",
    "models.catalogUnreachable": "Could not fetch the model catalog. Check your connection and credentials.",
    "models.catalogUpdated": "Model catalog updated from provider.",
    "models.disableAll": "Disable all",
    "models.disableShown": "Disable filtered models",
    "models.enableAll": "Enable all",
    "models.enableShown": "Enable filtered models",
    "models.enabledClear": "Enable all models",
    "models.enabledClearHint": "Clear model filters for all providers.",
    "models.enabledCount": "{enabled}/{total} enabled",
    "models.enabledCustomEmpty": "This provider has no available models. Save your changes and verify the API key.",
    "models.enabledFilter": "Filter available models",
    "models.enabledFilterPlaceholder": "Filter {count} models…",
    "models.enabledLastModel": "Keep at least one model enabled.",
    ...
    "models.enabledProjectScope": "This project overrides enabledModels in .pi/settings.json, so these switches are read-only. Edit that file directly.",
    "models.enabledProviderToggle": "Enable all models for {provider}",
    "models.enabledPrune": "Remove stale entries",
    "models.enabledPruneHint": "Remove entries that match no available model and preserve the rest.",
    "models.enabledSection": "Available models",
    "models.enabledStale": "{count} stale entries",
    "models.enabledStaleHint": "Models require provider credentials. Missing credentials, renamed or removed models, and settings from another machine can make entries stale.",
    "models.enabledToggle": "Show {model} in the model selector",
    "models.enabledUnavailable": "Sign in to this provider to select models.",
    "models.refreshCatalog": "Refresh model catalog",
    "models.refreshCatalogHint": "Fetch the provider’s current models. The built-in list is fixed to the bundled Pi version; newly released models appear after a refresh.",
