...
function effectiveCompat(provider: ProviderEntry, model: ModelConfigEntry): Record<string, unknown> {
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div>
        ...
        <div style={{ display: "flex", gap: 20, flexWrap: "wrap", marginTop: 8 }}>
          ...
          <Check label={t("models.fastPriority")} checked={model.fast ?? false} onChange={(v) => set("fast", v || undefined)} />
...
export function ModelsConfig({ onClose, onModelsChanged, embedded = false, cwd = null }: {
  onClose: () => void;
